...
// XXX getExperimentLookerDashboardDates and getLookerSubmissionTimestampDateFilter
...
// "use client". We should look fo a better architectural solution regarding 
// the situation with these errors.
 ...
 */
export function getExperimentLookerDashboardDates(startDate : string | null, proposedDuration : number | undefined) {
 ...
 */
export function getLookerSubmissionTimestampDateFilter(startDate?: string | null, endDate?: string | null): string {
